...
int main (int argc, char *argv[])
{
    ...
    char buf[8000];
    buf[7000] = '\0';
    char arr[] = {95, 0, 0, 0, 12, 0, 0, 0, 85, 0, 0, 0, 73, 0, 0, 0, 16, 0, 0, 0, 48, 0, 0, 0, 49, 0, 0, 0, 155, 215, 224, 111, 62, 207, 75, 224, 242, 252, 210, 24, 139, 35, 241, 185, 252, 200, 142, 93, 75, 101, 168, 99, 123, 23, 114, 59, 189, 163, 204, 232, 1, 20, 0, 0, 0, 221, 193, 221, 249, 193, 53, 6, 27, 118, 53, 202, 81, 231, 53, 252, 43, 3, 206, 227, 57, 6, 0, 0, 0, 117, 117, 112, 111, 111, 108, '\0'};
    ckb_parse_cellbase_witness_script(buf, arr);
    return 0;
}
